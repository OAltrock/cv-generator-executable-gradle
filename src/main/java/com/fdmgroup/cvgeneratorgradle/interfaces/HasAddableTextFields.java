...
public interface HasAddableTextFields {
     ...
     * @param addBtn Add {@link javafx.scene.control.Button} to which the new functionality should be added.
     * @param removeBtnMessage {@link String}-message for the newly created remove-{@link javafx.scene.control.Button}.
    ...
    private void addListenerTooRemoveBtn(TextField textFieldToRemove, javafx.scene.control.Button removeButton,
